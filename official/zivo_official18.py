        ...
        if sender and chat==sender:
            ...
            if stage in {"welcome_text","welcome_photo","speaker_learn","speaker_delete"}:
                ...
                if stage=="welcome_photo":
                    ...
                    path=Path("/opt/zivo60/welcome_media")/f"official18_{gid}_{int(time.time())}.jpg"
...
class ZivoOfficialApp:
    ...
    def run(self) -> None:
        ...
        log.info("startup | app=%s version=%s transport=official-bot-api bridge=unix-socket-direct ux=receipt-ledger-welcome-speaker-v18", APP_NAME, VERSION)
