...
import tempfile
import zivo_official18 as mod
assert mod.VERSION=='zivo-official18'
assert str(mod.BASE_DIR)=='/opt/ZIVO_OFFICIAL_BOT18'
...
print('ZIVO OFFICIAL18 RECEIPT/WELCOME/SPEAKER TEST: PASS')
